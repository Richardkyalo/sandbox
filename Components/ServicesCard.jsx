...
const cardData = [
  {
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-card-fill-green-500 text-green-500 checklist" viewBox="0 0 16 16">
  ...
  },
  {
    title: "SEO Services",
    description: "This is a wider card with supporting text below as a natural content.",
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-searc fill-green-500 text-green-500h" viewBox="0 0 16 16">
  ...
  },
  {
    title: "Consultancy",
    description: "This is a wider card with supporting text below as a natural content.",
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-chat- fill-green-500 text-green-500square-dots" viewBox="0 0 16 16">
  ...
  },
  {
    title: "24/7 Supports",
    description: "This is a wider card with supporting text below as a natural content.",
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-alarm fill-green-500 text-green-500" viewBox="0 0 16 16">
  ...
  },
  {
    title: "Creative ads",
    description: "This is a wider card with supporting text below as a natural content.",
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" className="bi bi-badge fill-green-500 text-green-500-ad" viewBox="0 0 16 16">
