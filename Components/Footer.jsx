  ...
  return (
    <footer className="py-10 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className='max-w-md'> 
            ...
            <p className="text-sm mt-2">
              At S-NDBOX, we are passionate about transforming your ideas into innovative digital solutions. With a team of skilled developers, designers, and strategists, we are dedicated to delivering high-quality software that drives business success. Our mission is to empower businesses with cutting-edge technology and exceptional service.
            </p>
            
          </div>
          <div>
            <h3 className="text-lg font-bold text-green-500">Important Links</h3>
            <div className="flex flex-col mt-4">
              <Link href="/terms" className="hover:underline">Terms And Conditions</Link>
              <Link href="/privacy" className="hover:underline">Privacy Policy</Link>
              <Link href="/careers" className="hover:underline">Careers</Link>
              <Link href="/releases" className="hover:underline">Upcoming Releases</Link>
          ...
          <div>
            <h3 className="text-lg font-bold text-green-500">Contact Information</h3>
            <p className="text-sm mt-2">Email: info@s-ndbox.com</p>
            <p className="text-sm">Phone: +1 (555) 123-4567</p>
            <p className="text-sm">Address: 1234 Innovation Drive, Tech City, TX 75001</p>
        ...
        {/* <div>
            <h3 className="text-lg font-bold text-green-500">Subscribe to our Newsletter</h3>
            <form className="flex flex-col space-y-2 mt-2">
              <input type="email" placeholder="Your email" className="border border-gray-300 outline-green-500 p-2 rounded" />
              <button type="submit" className="bg-green-500 text-white p-2 rounded hover:bg-green-600">Subscribe</button>
            </form>
            
          </div> */}
          
          {/* <div>
            <h3 className="text-lg font-bold text-green-500">Sitemap</h3>
